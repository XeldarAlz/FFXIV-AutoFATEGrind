...
public sealed class ConfigWindow : Window, IDisposable
{
    ...
    private int consumablePickerSelection;
    ...
    private void DrawContent(Configuration cfg)
    {
        ...
        switch (activeTab)
        {
            ...
            case Tab.Consumables: DrawHeader("Consumables", "Keep food and medicine buffs up while grinding — Well Fed is a free +3% EXP."); DrawConsumablesTab(cfg); break;
            ...
            case Tab.PartyInvites: DrawHeader("Party invites", "Auto-decline incoming party invites during a run, after a human-like delay, with an optional reply."); DrawPartyInvitesTab(cfg); break;
    ...
    private void DrawConsumablesTab(Configuration cfg)
    {
        SettingsRow.Draw("Auto-consume food & medicine",
            ...
            () => DrawToggle(cfg, () => cfg.AutoConsume, v => cfg.AutoConsume = v, "##con_on"));
    ...
    private void DrawAddConsumableRow(Configuration cfg)
    {
    ...
    private static void DrawPartyInvitesTab(Configuration cfg)
    {
        SettingsRow.Draw("Auto-decline party invites",
            ...
            () => DrawToggle(cfg, () => cfg.DeclinePartyInvites, v => cfg.DeclinePartyInvites = v, "##pi_on"));
        ...
        SettingsRow.Draw("Send a reply",
            ...
            () => DrawToggle(cfg, () => cfg.DeclineInviteReply, v => cfg.DeclineInviteReply = v, "##pi_reply_on"));
