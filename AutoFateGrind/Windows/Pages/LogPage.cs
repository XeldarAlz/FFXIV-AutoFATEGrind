...
internal sealed partial class LogPage
{
    ...
    private static readonly string[] chipIds = ["##afg_log_verbose", "##afg_log_debug", "##afg_log_info", "##afg_log_warning", "##afg_log_error"];
    ...
    private void DrawToolbar()
    {
        ...
        if (SearchField.Draw("##afg_log_search", Loc.T(L.Log.SearchHint), ref search, ref searchFocused, searchWidth, height, focusSearch))
        {
            ClearSelection();
        }
        ...
        if (PillButton.Draw("##afg_log_copy", copyLabel, Styling.AccentViolet, PillButton.Emphasis.Filled, FontAwesomeIcon.Copy,
        ...
        if (PillButton.Draw("##afg_log_clear", clearLabel, clearArmed ? Styling.AccentRose : Styling.TextSecondary,
    ...
    private void DrawFilters()
    {
        ...
        if (source is not null)
        {
            ...
            ImGui.SetCursorScreenPos(new Vector2(x, y));
            if (FilterChip.Draw("##afg_log_source", label, null, Styling.AccentPink, true, height, FontAwesomeIcon.Times, Loc.T(L.Log.SourceChipTooltip)))
            {
                source = null;
                ClearSelection();
            }
