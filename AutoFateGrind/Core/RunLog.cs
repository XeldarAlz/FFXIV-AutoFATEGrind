...
// console instead of digging the [AFG] lines out of dalamud.log. IPC callbacks and file loads log
...
public static class RunLog
{
    ...
    {
        Svc.Log.Warning(exception, $"{AfgConstants.LogPrefix} {message}");
    ...
    {
        Svc.Log.Error($"{AfgConstants.LogPrefix} {message}");
    ...
    {
        Svc.Log.Error(exception, $"{AfgConstants.LogPrefix} {message}");
